...
llvm::Value *CodeGenFunction::EmitVectorExpr(const Expr *E) {
  assert(E->getType()->getTypeClass() == Type::ConstantArray);
  ...
  if (BinaryOperator::classof(E)) {
    ...
    llvm::AllocaInst *AllocI = CreateTempAlloca(LTyI);
    AllocI->setName("autogenerated.for.i");
    AllocI->setAlignment(4);

    // Allocate a temp array to store the result
    ...
    llvm::StoreInst *InitI = Builder.CreateStore(llvm::ConstantInt::get(LTyI, llvm::APInt(32, 0)), (llvm::Value*)AllocI, false);
    InitI->setAlignment(4);

    // Create BBs
    llvm::BasicBlock *CondBlock = createBasicBlock("autogenerated.for.cond");
    llvm::BasicBlock *BodyBlock = createBasicBlock("autogenerated.for.body");
    llvm::BasicBlock *ExitBlock = createBasicBlock("autogenerated.for.exit");
    ...
    llvm::Value *CondCmp = Builder.CreateICmpULT(idx, CondCmpRHS, "autogenerated.for.cond.cmp");
    ...
    if (bo->getOpcode() == BO_Assign) {
      ...
      AllocR->setName("autogenerated.tempresult");
    ...
    llvm::LoadInst *IncLoadI = Builder.CreateLoad((llvm::Value*)AllocI, "");
    IncLoadI->setAlignment(4);
    llvm::Value* IncAdd = Builder.CreateAdd((llvm::Value*)IncLoadI, One, "");
    llvm::StoreInst *IncStoreI = Builder.CreateStore(IncAdd, (llvm::Value*)AllocI, false);
